...
**Atualizado:** 15/07/2026 (FE **v1.9.54** + GAS **v1.5.194** I112 bônus na cesta)
...
|--------|------|-------------------------|-----------|
| **Frontend** | **v1.9.54** | https://ribocg-a11y.github.io/movikids/?force=1.9.54 | após push |
| **Gestão Pessoas** | **v1.9.54** | `gestao-pessoas.html?force=1.9.54` | |
| **Portal acompanhar** | **v1.9.54** | `acompanhar.html` | |
...
**Para colar no Editor (usar sempre este link — confira **linha 2** = v1.5.194):**

https://raw.githubusercontent.com/ribocg-a11y/movikids/main/MOVIKIDS_Code_v1.5.32_AUTH_OPERADORES_SOBRE_v1.5.31.gs

**Header:** v1.5.194 · I112 bônus na cesta · I111 VT Q1=0 · I110 · I108
