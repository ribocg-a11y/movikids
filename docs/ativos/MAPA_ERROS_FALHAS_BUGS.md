...
| **I82** | **Operadores/Escala vazio — `painelGestaoPessoasAdmin` null row [4]** | Todas abas RH vazias; FE modo parcial `_partial` | GAS **v1.5.179** `gpSafeRows_` metas · `gpRows_` comunicados/avaliacoes · try/catch painel · FE **v1.9.14** erro visível | `TESTE_GESTAO_PESSOAS_READONLY.ps1` | painel ok · escala linhas preenchidas |
