...
| **I118** | **Caixa crash `maq is not defined`** | Toast “Erro ao carregar caixa” após I117 (contas tbody) | FE **v1.9.60** restaura `const maq` + tip POS≈abertas | I117 | render contas OK |
