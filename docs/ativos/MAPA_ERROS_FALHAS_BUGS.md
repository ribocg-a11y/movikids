...
| **I125** | **Salvar locação / ▶ cronômetro 18s+8s (reincidente)** | openById repetido; scan; FB; audit; setValues 28 cols | GAS **v1.5.204** I125c (cache ss_ + invalidate leve + ▶ 3 células + sem audit no hot path) · FE **v1.9.68** | `guard.i125.*` · **`TESTE_I125_SALVAR_INICIAR_PERF`** | salvar&lt;8s · ▶&lt;5s |
