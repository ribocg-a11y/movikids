...
- Informar: FE **v1.7.70**, GAS **v1.5.63**, próximo passo do checklist
...
|--------|--------|-------------|
| **Frontend** | **v1.7.70** | `mk-version.js` → `window.MK_VERSION` |
| **Service Worker** | **1.7.70** | `sw.js` → `SW_VERSION` |
...
| **App tablet** | v1.7.70 | https://ribocg-a11y.github.io/movikids/?force=1.7.70 |
...
| Item | Status |
|------|--------|
| Pacote M.6 `mk-nova.js` v1.7.70 | ✅ código — **tablet Nova locação** ⬜ |
| Pacote M.7+ (admin/drawer) | ⬜ próximo técnico |
