...
**Atualizado:** 15/07/2026 (FE **v1.9.57** + GAS **v1.5.194** I112 bônus na cesta)
...
|--------|------|-------------------------|-----------|
| **Frontend** | **v1.9.57** | https://ribocg-a11y.github.io/movikids/?force=1.9.57 | após push |
| **Gestão Pessoas** | **v1.9.57** | `gestao-pessoas.html?force=1.9.57` | |
| **Portal acompanhar** | **v1.9.57** | `acompanhar.html` | |
