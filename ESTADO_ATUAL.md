...
|--------|-------------|----------|
| **Frontend** | **v1.7.26** | https://ribocg-a11y.github.io/movikids/?force=1.7.26 |
| **Apps Script** | **v1.5.44** (colar + Nova versão Web) | Deploy `AKfycbwakQ-_aWsF5lFGLsiwB5UvJ4AlpW88krSv8daPeMvULwX5FOIdMhGVgdGd0G35270Y` |
...
→ deve retornar `versao: v1.5.44` e `postWriteActions` com as 5 escritas críticas
...
| Artefato | Arquivo |
|----------|---------|
| GAS | `MOVIKIDS_Code_v1.5.32_AUTH_OPERADORES_SOBRE_v1.5.31.gs` (header **v1.5.44**) |
...
Commits de referência: `b4cf32d` … `3d9d106` (branch `main`).
...
| 3 | Pacote E — segurança/auditoria backend | **feito** | v1.7.26 + GAS v1.5.44 |
...
2. Tablet → `?force=1.7.26`, rodapé **Online v1.7.26**
...
Scripts: `TESTE_REGRESSAO_MOVIKIDS_PROD_SAFE.ps1`, `TESTE_DRAWER_E_PACOTE_E.ps1`, `TESTE_RELACIONAMENTO_MOVIKIDS_READONLY.ps1`
