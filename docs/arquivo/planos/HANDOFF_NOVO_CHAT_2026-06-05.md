...
> ## ⛔ NÃO USAR — ARQUIVADO
>
> Este arquivo está **defasado** (v1.7.27 / v1.5.46).  
> **Use o handoff ativo:** [`docs/ativos/HANDOFF_NOVO_CHAT.md`](../../ativos/HANDOFF_NOVO_CHAT.md)

---

# MOVI KIDS — Handoff para novo chat (ARQUIVADO)
