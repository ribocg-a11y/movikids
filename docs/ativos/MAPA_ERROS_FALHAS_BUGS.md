...
| **I158** | **Golden PDF/e-mail contava Cancelada** | GAS `_gerarHtmlRelatorio_` excluía só Ativa | **FE v1.9.120** `mkHtmlRelatorioGoldenFromKpi_` via kpiMes (sem AppScript) · `guard.i158.fe.golden` | `INCIDENTE_I158_*` | ✅ FE · ago enviado ao Golden = R$ 17.212 (histórico) |
