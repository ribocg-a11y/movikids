...
**Atualizado:** 10/07/2026 — **I96–I99** multi-veículo · FE **v1.9.36** · GAS **v1.5.187**  
...
| **I103** | **Home: tile contas únicas · lista+Caixa todas locações** | Tile 12 vs 8 contas confuso sem rótulo | FE **v1.9.38** `stat-nloc`=contas · chip/cx=`nSessoes` | I42 ARQUITETURA_CAIXA | tile contas · lista N locações |
