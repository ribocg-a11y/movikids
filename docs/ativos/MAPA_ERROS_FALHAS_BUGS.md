...
**Atualizado:** 15/07/2026 — **I109b** pot FSS R$50 cada · FE **v1.9.51** · GAS **v1.5.191**  
...
| **I109** | **Bônus FSS Raykelly+Julia** | Pot R$100 deve ser metade pra cada (não R$100 só pra quem bateu) | GAS **v1.5.191** `metaBonusValorDoDia_` pot FSS · FE **v1.9.51** | I84 | Ray **350** · Julia **150** (jul) |
