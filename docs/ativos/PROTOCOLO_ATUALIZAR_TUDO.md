...
**Criado:** 14/06/2026 · **Última execução:** 15/07/2026 (FE **v1.9.53** · GAS **v1.5.193** · I111 Q1 VT já pago)  
...
|--------|--------|-----------|
| GAS | **v1.5.193** | repo · Nova versão Web pendente I111 |
| FE | **v1.9.53** | I111 pacote Q1 = PIX+VA |
