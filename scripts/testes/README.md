...
**Versões de referência (29/08/2026):** FE **v1.9.105** · GAS ping **v1.5.211** · mínimo operação balcão **v1.7.35** (I15 GET).
...
.\scripts\testes\TESTE_I120_ADMIN_PERF_READONLY.ps1
.\scripts\testes\TESTE_I121_DASH_SYNC_READONLY.ps1
