...
**Atualizado:** 29/07/2026 · FE **v1.9.67** (I125) · GAS repo **v1.5.203** · Web ping **v1.5.202** ⏳ Nova versão I125b  
...
**GitHub:** `ribocg-a11y/movikids` · branch `main` · **I125b:** salvar/▶ sem Firebase no caminho crítico
