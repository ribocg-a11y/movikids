// ═══════════════════════════════════════════════════════════
// MOVI KIDS — Google Apps Script v1.5.20
...
// v1.5.20: camada segura de configuracao operacional com fallback hardcoded
...
function carregarOperacaoConfig_() {
  try {
    return resp_({ versao: 'v1.5.20', config: operacaoConfig_() });
  } catch(ex) {
