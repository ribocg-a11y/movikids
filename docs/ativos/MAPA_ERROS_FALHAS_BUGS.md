...
| **I138** | **Holerite: total 1ª inflado + VT no pacote** | “Já pago” usava meta atual (1273≠948); VT Q2 somava no fim | FE **v1.9.83** memorial Q1 948,40 · VT nunca no pacote | `mk-holerite.js` | Total 1ª = PIX+VA; VT semanal R$0 |
