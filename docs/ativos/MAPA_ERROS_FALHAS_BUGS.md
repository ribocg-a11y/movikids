...
**Atualizado:** 15/07/2026 — **I116** enrich login sem expandir RH · GAS repo **v1.5.196** · FE **v1.9.58** · Web **v1.5.195** até Nova versão  
...
| **I116** | **Enrich login expandia todo RH + lento app-wide** | Frios Colab ainda altos; `kpiMes` ~34s; admin GP ~45s | GAS **v1.5.196** `expandRh:false` no login · escala/banco via ctx · kpiMes/admin = backlog | I115 · I73 · I23 | colar 196 · frio Colab &lt;12s · ver incidente |
