...
| **I50** | **Faltas falsas** — sem ponto na escala = desconto holerite (I46) | Raykelly −R$ 270 sem falta real | GAS **v1.5.144** · `Sem ponto` · só falta manual | nunca sync jornada → FALTAS | `TESTE_FALTAS_HOLERITE_READONLY` |
