...
**Monólito em redução (Pacote M):** `index.html` **~5.053 linhas** (v1.7.70). Extraídos: `mk-app.css`, bootstrap, `mk-api.js`, `mk-sync.js`, `mk-sessao.js`, `mk-nova.js`, `mk-auth.js` — ver `PACOTE_M_MODULARIZACAO.md`.
