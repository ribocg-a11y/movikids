...
| **Apps Script canônico** | `MOVIKIDS_Code_v1.5.32_AUTH_OPERADORES_SOBRE_v1.5.31.gs` | Só sócio + Nova versão Web · **I115:** slim `gpBuildPainelColaboradorPayload_` só com §7.3 |
