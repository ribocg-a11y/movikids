...
**Atualizado:** 15/07/2026 (FE **v1.9.52** Pages ✅ + GAS **v1.5.192** Web ✅ I110)
...
|--------|------|-------------------------|-----------|
| **Frontend** | **v1.9.52** | https://ribocg-a11y.github.io/movikids/?force=1.9.52 | ✅ Pages live |
...
| **GAS** | **v1.5.192** (header `.gs`) | ping **v1.5.192** | ✅ Web = repo (I110) |
