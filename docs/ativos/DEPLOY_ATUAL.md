...
**Atualizado:** 15/07/2026 (FE **v1.9.58** + GAS **v1.5.195** I115 slim login Colaboradores)
...
|--------|------|-------------------------|-----------|
| **Frontend** | **v1.9.58** | https://ribocg-a11y.github.io/movikids/?force=1.9.58 | após push |
...
| **GAS** | **v1.5.195** (header `.gs`) | ping até **Nova versão** I115 | ⚠️ colar + implantar I115 |
...
**Para colar no Editor (usar sempre este link — confira **linha 2** = v1.5.195):**

https://raw.githubusercontent.com/ribocg-a11y/movikids/main/MOVIKIDS_Code_v1.5.32_AUTH_OPERADORES_SOBRE_v1.5.31.gs

**Header:** v1.5.195 · I115 slim login Colaboradores · I111 VT Q1=0 · I110 · I108
