...
| **App (GitHub Pages)** | https://ribocg-a11y.github.io/movikids/?force=1.7.6 |
...
Após implantar, o `ping` deve mostrar `versao` **v1.5.37** (mínimo **v1.5.36** para `corrigirFinanceiroLocacaoAdmin`).
...
`MOVIKIDS_Code_v1.5.32_AUTH_OPERADORES_SOBRE_v1.5.31.gs` (header **v1.5.37**)
...
Publicar **v1.7.6** no GitHub (`git push`). Tablets: `?force=1.7.6`.
