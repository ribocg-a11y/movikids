...
| **I102** | **Home stat "Contas hoje" vs lista Encerradas hoje** | Tile 7 contas · lista 10 sessões — operador confuso | FE **v1.9.37** stat = `nSessoes` = `encHoje.length` | label "Encerradas hoje" | contar itens da lista |
