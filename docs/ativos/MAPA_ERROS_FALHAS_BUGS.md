...
| **I148** | **Encerrar fantasma: card Ativa após já Encerrada** | Iza #3112 encerrada 13:33 sem extra; tela 14:20 ainda Ativa +44; 2º encerrar 409 e card ficava | FE **v1.9.106** 409 já-encerrada remove card+snapshot · caixa 29/08 extra +44 restaurado | `mk-drawer.js` · `mkSnapshotDropAtivo_` | card some; extra corrige no Caixa |
